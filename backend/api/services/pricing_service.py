...
class ServicioPrecios:
    ...
    def calcular_precio_habitacion(self, habitacion: Habitacion, fecha_entrada, fecha_salida):
        ...
        for indice in range(cantidad_noches):
            ...
            detalle = self._calcular_noche(habitacion, fecha_noche)
    ...
    def _calcular_noche(self, habitacion: Habitacion, fecha_noche):
        ...
        tasa_ocupacion = self._calcular_ocupacion_hotel(fecha_noche)
    ...
    def _calcular_ocupacion_hotel(self, fecha_noche):
